...
export const DEFAULT_REPOSITORY = 'fish2018/fant';

export const DEFAULT_ACTION_REPOSITORIES = ['sf-tools/ant', 'fish2018/fant'];
export const DEFAULT_RELEASE_REPOSITORY = 'fish2018/fant';
