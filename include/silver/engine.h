...
#ifndef ANT_JIT
static inline void sv_tfb_record2(
...
static inline void sv_tfb_record1(
  sv_func_t *func, uint8_t *ip, ant_value_t v
) {
  (void)func;
  (void)ip;
  (void)v;
...
static inline void sv_tfb_record_local(
  sv_func_t *func, int idx, ant_value_t v
) {
  (void)func;
  (void)idx;
  (void)v;
